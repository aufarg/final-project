...
oleh \textit{function pointer} \code{destroy\_domain} pada struktur yang telah dijelaskan pada
...
\begin{figure}
\begin{lstlisting}[
	caption={Data struktur untuk komunikasi yang dapat dimengerti \textit{scheduler} dan \textit{user space}},
...
\begin{figure}
\begin{lstlisting}[
	caption={Fungsi yang digunakan \textit{user space} mengirim informasi kepada \textit{scheduler}},
...
\begin{figure}
\begin{lstlisting}[
	caption={Fungsi yang digunakan \textit{user space} meminta informasi partisi dari \textit{scheduler}},
