...
\begin{figure}[!ht]
	...
	\begin{tabular}{c}
		\subfloat{
			\includegraphics[scale=0.18]{reliability-s6-delta-p1.png}
		} \\
		\subfloat{
			\includegraphics[scale=0.18]{reliability-s6-error-p1.png}
		}
	\end{tabular}
	\caption{Test result for scenario 5 (service 1)}
...
\begin{figure}[!ht]
	...
	\begin{tabular}{c}
		\subfloat{
			\includegraphics[scale=0.18]{reliability-s6-delta-p2.png}
		} \\
		\subfloat{
			\includegraphics[scale=0.18]{reliability-s6-error-p2.png}
		}
	\end{tabular}
	\caption{Test result for scenario 5 (service 2)}
...
\begin{figure}[!ht]
	...
	\begin{tabular}{c}
		\subfloat{
			\includegraphics[scale=0.18]{reliability-s6-delta-p3.png}
		} \\
		\subfloat{
			\includegraphics[scale=0.18]{reliability-s6-error-p3.png}
		}
	\end{tabular}
	\caption{Test result for scenario 5 (service 3)}
	\label{figure:hasil_keandalan_s6_service3}
\end{figure}

Test results show that using primary-backup scheme indeed increase the reliability of the
service. The increase is indicated by continuous sample even when a partition experienced a
failure as depicted in \figurename ~\ref{figure:hasil_keandalan_s6_service1}, \figurename
~\ref{figure:hasil_keandalan_s6_service2}, and \figurename
~\ref{figure:hasil_keandalan_s6_service3}.  Unfortunately, \tablename ~\ref{table:test_result}
shows that the latency for each heartbeat is quite high, which makes it unsuitable for
production environment.
% We tested the primary-backup ARINC 653 scheduler by having five partitions, named as P1 to P5.
% The first two partitions (P1 and P2) provide service $A$ and the last three partitions (P3,
% P4, and P5) provide service $B$. The testing scenarios on these partitions, including the
